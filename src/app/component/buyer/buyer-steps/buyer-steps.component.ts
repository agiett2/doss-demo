  ...
  ngOnInit(): void {
    ...
    this.steps = [
      ...
      // tslint:disable-next-line: max-line-length
      {
        ...
        // tslint:disable-next-line:max-line-length
        detail: `The Mortgage Company has given a “CLEAR-to-CLOSE” which means everything is done and ready to go to the Attorney/Title Company. However, before we sign on the dotted-line, your techAGENT is taking you back to the property to make sure that everything is as we negotiated in the contract. If something is damaged or not done, your techAGENT will immediately contact the Sellers Agent to remedy the issues. However, if everything is perfect, then you are ready to sign the Lenders paperwork to finalize the deal. Be sure to let your techAGENT know if you need help setting up cable, security, and/or utilities. Our Concierge Team is there to roll out the red carpet!`
      },
      // tslint:disable-next-line: max-line-length
      {
        step: 'Closing Time...',
        // tslint:disable-next-line:max-line-length
        detail: `The Attorney/Title Company will tell you and your techAGENT the amount you need to bring to the closing table. This can not be a personal check. Go to your bank, get a cashiers-check, and bring it to the closing. Only do a wire if necessary. Sign your life away, and welcome home!!`
      }
    ];
  }
}
